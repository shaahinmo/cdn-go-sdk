...
type _ARecordValue ARecordValue
...
func (o *ARecordValue) UnmarshalJSON(data []byte) (err error) {
	...
	varARecordValue := _ARecordValue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varARecordValue)

	if err != nil {
		return err
	}

	*o = ARecordValue(varARecordValue)
