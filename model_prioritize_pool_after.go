...
type _PrioritizePoolAfter PrioritizePoolAfter
...
func (o *PrioritizePoolAfter) UnmarshalJSON(data []byte) (err error) {
	...
	varPrioritizePoolAfter := _PrioritizePoolAfter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPrioritizePoolAfter)

	if err != nil {
		return err
	}

	*o = PrioritizePoolAfter(varPrioritizePoolAfter)
