...
type _TransportLayerProxyUpdate TransportLayerProxyUpdate
...
func (o *TransportLayerProxyUpdate) UnmarshalJSON(data []byte) (err error) {
	...
	varTransportLayerProxyUpdate := _TransportLayerProxyUpdate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransportLayerProxyUpdate)

	if err != nil {
		return err
	}

	*o = TransportLayerProxyUpdate(varTransportLayerProxyUpdate)
