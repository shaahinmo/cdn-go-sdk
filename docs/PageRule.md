...
**RewriteUrl** | Pointer to **string** | You cannot combine rewrite with redirect and secure link | [optional] [default to "/path"]
...
**EdgeComputeId** | Pointer to **string** | UUID of an edge compute. This field is in &#x60;alpha&#x60; version. | [optional] 
