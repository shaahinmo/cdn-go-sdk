...
type _CdnAppTriggerWebhook CdnAppTriggerWebhook
...
func (o *CdnAppTriggerWebhook) UnmarshalJSON(data []byte) (err error) {
	...
	varCdnAppTriggerWebhook := _CdnAppTriggerWebhook{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCdnAppTriggerWebhook)

	if err != nil {
		return err
	}

	*o = CdnAppTriggerWebhook(varCdnAppTriggerWebhook)
