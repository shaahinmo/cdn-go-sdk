...
type _TransportLayerProxyServer TransportLayerProxyServer
...
func (o *TransportLayerProxyServer) UnmarshalJSON(data []byte) (err error) {
	...
	varTransportLayerProxyServer := _TransportLayerProxyServer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransportLayerProxyServer)

	if err != nil {
		return err
	}

	*o = TransportLayerProxyServer(varTransportLayerProxyServer)
