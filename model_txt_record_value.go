...
type _TXTRecordValue TXTRecordValue
...
func (o *TXTRecordValue) UnmarshalJSON(data []byte) (err error) {
	...
	varTXTRecordValue := _TXTRecordValue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTXTRecordValue)

	if err != nil {
		return err
	}

	*o = TXTRecordValue(varTXTRecordValue)
