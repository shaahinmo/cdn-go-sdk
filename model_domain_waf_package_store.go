...
type _DomainWafPackageStore DomainWafPackageStore
...
func (o *DomainWafPackageStore) UnmarshalJSON(data []byte) (err error) {
	...
	varDomainWafPackageStore := _DomainWafPackageStore{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDomainWafPackageStore)

	if err != nil {
		return err
	}

	*o = DomainWafPackageStore(varDomainWafPackageStore)
