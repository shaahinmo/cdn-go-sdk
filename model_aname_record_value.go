...
type _ANAMERecordValue ANAMERecordValue
...
func (o *ANAMERecordValue) UnmarshalJSON(data []byte) (err error) {
	...
	varANAMERecordValue := _ANAMERecordValue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varANAMERecordValue)

	if err != nil {
		return err
	}

	*o = ANAMERecordValue(varANAMERecordValue)
