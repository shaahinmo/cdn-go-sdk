...
type AttackReportStatistics struct {
	Attacks *AttackReportStatisticsAttacks `json:"Attacks,omitempty"`
}
...
func (o *AttackReportStatistics) GetAttacks() AttackReportStatisticsAttacks {
	if o == nil || IsNil(o.Attacks) {
		var ret AttackReportStatisticsAttacks
		return ret
	}
	return *o.Attacks
}
...
// SetAttacks gets a reference to the given AttackReportStatisticsAttacks and assigns it to the Attacks field.
