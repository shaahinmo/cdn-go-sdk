...
// Filter log forwarders by name
func (r ApiLogForwardersIndexRequest) Name(name string) ApiLogForwardersIndexRequest {
	r.name = &name
	return r
}

// Filter log forwarders by type
func (r ApiLogForwardersIndexRequest) Types(types []string) ApiLogForwardersIndexRequest {
	r.types = &types
	return r
}
