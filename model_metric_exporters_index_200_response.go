...
// checks if the MetricExportersIndex200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricExportersIndex200Response{}

// MetricExportersIndex200Response struct for MetricExportersIndex200Response
type MetricExportersIndex200Response struct {
	Data []MetricExporterSummary `json:"data,omitempty"`
...
func NewMetricExportersIndex200Response() *MetricExportersIndex200Response {
	this := MetricExportersIndex200Response{}
	return &this
}
...
// SetData gets a reference to the given []MetricExporterSummary and assigns it to the Data field.
...
func (o MetricExportersIndex200Response) MarshalJSON() ([]byte, error) {
...
func (o MetricExportersIndex200Response) ToMap() (map[string]interface{}, error) {
...
type NullableMetricExportersIndex200Response struct {
	value *MetricExportersIndex200Response
	isSet bool
}

func (v NullableMetricExportersIndex200Response) Get() *MetricExportersIndex200Response {
	return v.value
}

func (v *NullableMetricExportersIndex200Response) Set(val *MetricExportersIndex200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricExportersIndex200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricExportersIndex200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricExportersIndex200Response(val *MetricExportersIndex200Response) *NullableMetricExportersIndex200Response {
	return &NullableMetricExportersIndex200Response{value: val, isSet: true}
}

func (v NullableMetricExportersIndex200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricExportersIndex200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
