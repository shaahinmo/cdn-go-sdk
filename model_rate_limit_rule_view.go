...
type _RateLimitRuleView RateLimitRuleView
...
func (o *RateLimitRuleView) UnmarshalJSON(data []byte) (err error) {
	...
	varRateLimitRuleView := _RateLimitRuleView{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRateLimitRuleView)

	if err != nil {
		return err
	}

	*o = RateLimitRuleView(varRateLimitRuleView)
