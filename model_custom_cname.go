...
func (o *CustomCname) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomCname := _CustomCname{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomCname)

	if err != nil {
		return err
	}

	*o = CustomCname(varCustomCname)
