...
type _TransportLayerProxyStore TransportLayerProxyStore
...
func (o *TransportLayerProxyStore) UnmarshalJSON(data []byte) (err error) {
	...
	varTransportLayerProxyStore := _TransportLayerProxyStore{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransportLayerProxyStore)

	if err != nil {
		return err
	}

	*o = TransportLayerProxyStore(varTransportLayerProxyStore)
